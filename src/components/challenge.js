    ...
    <section className="challange">
      <div className="container">
        <div className="challange-wrap">
          ...
          <a href="https://github.com/realvjy/illlustrations/releases/download/v1.0/illlustrations.co-1.0.0.zip" target="__blank" className="c-dwn">Download all</a><a href="https://dribbble.com/realvjy/projects/459862-100-Days-of-Illustration" target="__blank" className="c-drb">View on Dribbble</a>
        </div>
      </div>
    </section>
  )
